...
\end{itemize}
Tutto il materiale utilizzato per la creazione dei container è presente nel branch \texttt{main} della directory Bitbucket:\\
\texttt{https://davprs@bitbucket.org/davprs/anti-theft-system-for-vehicle.git}}
\subsubsection{Setup}
Eseguire il comando:\\
...
.2 device-simulator.
.3 Hardware\_Simulator.main.jar.
.2 webApp.
.3 server.
.4 init-mongodb.
.5 data.
...
.5 init.sh.
.4 ASW\_saved.tgz.
.3 docker\_load\_and\_run.bat.
.3 docker\_load\_and\_run.sh.
